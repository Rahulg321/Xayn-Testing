...
const questions = [
  "Are whistleblowers protected from retaliation by Noxtua when reporting data handling issues?",
  "Does Noxtua comply with regulations by protecting whistleblowers from retaliation when they report data handling issues?",
  "What ethical standards guide Noxtua in protecting whistleblowers from retaliation when they report data handling issues?",
  "What technical measures are implemented by Noxtua to ensure whistleblowers are protected from retaliation when reporting data handling issues?",
  "How does Noxtua ensure that the effectiveness of whistleblower protection measures is regularly reviewed and improved, and what mechanisms are in place to address any potential weaknesses or gaps in the current system?",
];

// Test suite
describe("evaluating twhistleblowers protected from retaliation by Noxtua", async () => {
  ...
  afterAll(async () => {
    await writeLogs(
      ...
      testResults,
      ratingResults,
      "ethical-compliance/whistleblower"
    );
  });
});
