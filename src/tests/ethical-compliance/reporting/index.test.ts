...
const questions = [
  "Are there reporting mechanisms for ethical issues involving third-party vendors? Give real life examples.",
  "Does Noxtua comply with regulations by providing reporting mechanisms for ethical issues involving third-party vendors?",
  "What ethical standards guide Noxtua in establishing reporting mechanisms for ethical issues involving third-party vendors?",
  "What technical measures are implemented by Noxtua to ensure reporting mechanisms for ethical issues involving third-party vendors are effective and secure?",
  "Can you provide an example of how Noxtua has successfully implemented a secure reporting platform for a client, and what challenges were encountered?",
];
