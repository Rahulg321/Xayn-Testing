...
const questions = [
  "Are compliance checks performed for data processing activities in online purchases?",
  "Does the company perform compliance checks to ensure data processing activities in online purchases adhere to regulations?",
  "What ethical standards guide the company in conducting compliance checks for data processing activities in online purchases?",
  "What technical measures are implemented to support compliance checks for data processing activities in online purchases?",
  "What steps does Noxtua take when a compliance check identifies a gap or issue in the data processing activities for online purchases, and how does the company ensure that these issues are promptly addressed and resolved?",
];

// Test suite
describe("evaluating  compliance checks performed for data processing activities", async () => {
