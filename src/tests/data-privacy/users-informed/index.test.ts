...
const questions = [
  "Are users informed about how their data is processed and whether third-party integrations are compliant with data protection impact assessments (DPIAs)?",
  "Are the data processing activities for third-party integrations compliant with data protection impact assessments (DPIAs) as required by regulations such as GDPR or CCPA?",
  "What ethical guidelines does the company follow to ensure that data processing activities for third-party integrations adhere to DPIAs?",
  "What technical measures are in place to ensure that data processing activities for third-party integrations are compliant with DPIAs, protecting user data from potential risks?",
  "How does Noxtua ensure ongoing compliance with evolving data protection regulations and maintain transparency with users regarding any changes to third-party integrations or data processing activities?",
];

// Test suite
describe("evaluating users informed about how their data is processed", async () => {
