...
let documentName = "vendor-agreement.pdf";
let testCategory = "AI FEEDBACK AND Learning";

let prompt = "Test for how well co-pilot learns from feedback and mistakes";
...
describe(`Document Testing: ${prompt}`, async () => {
  ...
  afterAll(async () => {
    await saveDocumentTestResult({
      prompt,
      testCategory,
      testName: "AI FEEDBACK and Learning",
      documentName,
      documentType: "Vendor Agreement / pdf file",
      aiResponse,
