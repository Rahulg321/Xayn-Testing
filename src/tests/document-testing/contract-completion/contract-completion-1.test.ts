...
let testCategory = "Contract Completion and Review";

let prompt =
  "Incentive Stock Option Agreement was uploaded with missing blanks and Noxtua was asked to fill in the blanks.";
...
describe(`Document Testing: ${prompt}`, async () => {
  ...
  afterAll(async () => {
    await saveDocumentTestResult({
      prompt,
      testCategory,
      testName: "Contract Completion and Review",
      documentName,
