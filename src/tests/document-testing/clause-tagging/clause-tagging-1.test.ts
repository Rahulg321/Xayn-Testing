...
let documentName = "software_license_agreement.pdf";
let testCategory = "Clause Categorization and Tagging";

let prompt = "Test for categorizing clauses such as force majeure, IP rights";
