...
let testCategory = "Document Structure and Analysis";

let prompt =
  "Test for analyzing document structure and detecting issues like improper numbering";
...
describe(`Document Testing: ${prompt}`, async () => {
  ...
  afterAll(async () => {
    await saveDocumentTestResult({
      prompt,
      testCategory,
      testName: "Document Structure and Analysis",
      documentName,
