...
let testCategory = "Search and Filter";

let prompt = "Test for accuracy of search results for keywords or clauses";
...
describe(`Document Testing: ${prompt}`, async () => {
  ...
  afterAll(async () => {
    await saveDocumentTestResult({
      prompt,
      testCategory,
      testName: "Search and Filter Functionality",
      documentName,
      documentType: "Master Service Agreement / docx file",
      aiResponse,
